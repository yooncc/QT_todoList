    ...
    : QWidget{parent}
{
    ...
    memberListLabel->setStyleSheet(
        "QLabel {border-style: outset; border-width: 1px; border-color: blue;}");
    ...
    memberNameLabel->setStyleSheet(
        "QLabel {border-style: outset; border-width: 1px; border-color: red;}");
