...
void MainWindow::successedLogin(QString id)
{
    ...
    if (id == "admin") { // 매니저 로그인
        ...
        QAction *addMember = util.makeAction("",
                                             "추가(Q)",
                                             "Ctrl+Q",
                                             "회원을 새롭게 추가합니다.",
                                             this,
                                             SLOT(managerAdd()));
        QAction *deleteMember = util.makeAction("",
                                                "삭제(W)",
                                                "Ctrl+W",
                                                "선택한 회원 정보를 삭제합니다.",
                                                this,
                                                SLOT(managerDelete()));
        QAction *changeMember = util.makeAction("",
                                                "변경(E)",
                                                "Ctrl+E",
                                                "회원의 정보를 변경합니다.",
                                                this,
                                                SLOT(managerChange()));
        QAction *findMember = util.makeAction("",
                                              "조회(R)",
                                              "Ctrl+R",
                                              "회원의 정보를 조회합니다.",
                                              this,
                                              SLOT(managerFind()));
        QAction *logoutForManager = util.makeAction("",
                                                    "로그아웃(T)",
                                                    "Ctrl+T",
                                                    "로그아웃 합니다.",
                                                    this,
