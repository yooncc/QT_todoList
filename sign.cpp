    ...
    : QWidget{parent}
{
    ...
    repwField->setGeometry(QRect(margin,(pwField->y())+(pwField->height())+margin,viewWidth-(margin*2),30));

    signUpBtn = util.makePushButton(this,"회원가입 완료","",8,false,"");
    signUpBtn->setGeometry(QRect(margin,repwField->y()+repwField->height()+margin,viewWidth-(margin*2),30));
...
void sign::signComplete() {
    QMessageBox::StandardButton reply = QMessageBox::information(this,"회원가입 성공!",
